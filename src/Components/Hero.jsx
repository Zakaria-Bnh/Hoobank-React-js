...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY} flex-wrap`}>
    <div className={`flex-1 ${styles.paddingY} flex-col xl:px-0 sm:px-16 px-6`}>
      <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
        ...
        <p className={`${styles.paragraph} ml-2`}>
          ...
          With the right credit card, you can improve your financial life by building credit, earning rewards and saving money. But with hundreds of credit cards on the market. <span className="text-white">1 Month</span> Account
        </p>
      </div>
    ...
    <div className={`flex-1 min-w-[550px] flex ${styles.flexCenter} md:my-0 my-10 relative`}>
